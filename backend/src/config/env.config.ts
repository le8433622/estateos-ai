 ...
 * @type {CookieOptions}
 */
export const COOKIE_OPTIONS: CookieOptions = { httpOnly: true, secure: HTTPS, signed: true, sameSite: 'lax' }
 ...
 * @type {string}
 */
export const APPLE_CLIENT_ID_WEB = __env__('MI_APPLE_CLIENT_ID_WEB', false, 'APPLE_CLIENT_ID_WEB')
 ...
 * @type {string}
 */
export const APPLE_CLIENT_ID_MOBILE = __env__('MI_APPLE_CLIENT_ID_MOBILE', false, 'APPLE_CLIENT_ID_MOBILE')
 ...
 * @type {string}
 */
export const FACEBOOK_APP_ID = __env__('MI_FACEBOOK_APP_ID', false, 'FACEBOOK_APP_ID')
